...
export const PROJECTS = [
  ...
  },
  {
    ...
    Github:"https://github.com/rahul8279/chat-app",
    Demo :"https://chat-app-2tmo.onrender.com/"
  },
  {
    title: "JOB PORTAL",
    image: "https://th.bing.com/th/id/OIP.6mIEhub14VrCFHQBNU-0XwHaE7?w=272&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",
    description:
      "A full-stack job portal web application that connects job seekers with recruiters. Users can create profiles, upload resumes and photos, and apply for jobs, while recruiters can view applicant details and download resumes for evaluation.",
    technologies: ["React", "tailwindcss", "Node.js", "MongoDB"],
    Github:"https://github.com/rahul8279/jobPortal",
  },
];

export const CONTACT = {
  address: "Bhattowala Rishikesh Uttarakhand",
  phoneNo: "+918445056910",
